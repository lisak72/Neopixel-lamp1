 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/home/jirka2/programming/demoC_Neopixel/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /home/jirka2/programming/demoC_Neopixel/build/gen/mos_conf_schema.yml
 */
...
/* red */
#define MGOS_CONFIG_HAVE_RED
#define MGOS_SYS_CONFIG_HAVE_RED
int mgos_config_get_red(struct mgos_config *cfg);
static inline int mgos_sys_config_get_red(void) { return mgos_config_get_red(&mgos_sys_config); }
void mgos_config_set_red(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_red(int v) { mgos_config_set_red(&mgos_sys_config, v); }

/* green */
#define MGOS_CONFIG_HAVE_GREEN
#define MGOS_SYS_CONFIG_HAVE_GREEN
int mgos_config_get_green(struct mgos_config *cfg);
static inline int mgos_sys_config_get_green(void) { return mgos_config_get_green(&mgos_sys_config); }
void mgos_config_set_green(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_green(int v) { mgos_config_set_green(&mgos_sys_config, v); }

/* blue */
#define MGOS_CONFIG_HAVE_BLUE
#define MGOS_SYS_CONFIG_HAVE_BLUE
int mgos_config_get_blue(struct mgos_config *cfg);
static inline int mgos_sys_config_get_blue(void) { return mgos_config_get_blue(&mgos_sys_config); }
void mgos_config_set_blue(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_blue(int v) { mgos_config_set_blue(&mgos_sys_config, v); }

/* rpcset */
#define MGOS_CONFIG_HAVE_RPCSET
#define MGOS_SYS_CONFIG_HAVE_RPCSET
int mgos_config_get_rpcset(struct mgos_config *cfg);
static inline int mgos_sys_config_get_rpcset(void) { return mgos_config_get_rpcset(&mgos_sys_config); }
void mgos_config_set_rpcset(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_rpcset(int v) { mgos_config_set_rpcset(&mgos_sys_config, v); }
