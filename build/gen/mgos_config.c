...
const struct mgos_conf_entry mgos_config_schema_[396] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 395},
  ...
  {.type = CONF_TYPE_INT, .key = "red", .offset = offsetof(struct mgos_config, red)},
  {.type = CONF_TYPE_INT, .key = "green", .offset = offsetof(struct mgos_config, green)},
  {.type = CONF_TYPE_INT, .key = "blue", .offset = offsetof(struct mgos_config, blue)},
  {.type = CONF_TYPE_BOOL, .key = "rpcset", .offset = offsetof(struct mgos_config, rpcset)},
};
...
const struct mgos_config mgos_config_defaults = {
  ...
  .wifi.sta1.enable = 0,
  .wifi.sta1.ssid = "JLTest",
  .wifi.sta1.pass = "20192019",
  .wifi.sta1.user = NULL,
  ...
  .wifi.sta2.enable = 0,
  .wifi.sta2.ssid = "JLTest",
  .wifi.sta2.pass = "20192019",
  .wifi.sta2.user = NULL,
